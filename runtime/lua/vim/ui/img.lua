...
---@inlinedoc
---@field row? integer    starting row (1-indexed); buffer row if {buf} set, else editor-relative row
---@field col? integer    starting column (1-indexed); buffer col if {buf} set, else editor-relative col
