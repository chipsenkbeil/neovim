...
---
---The API is marked experimental with the underscore prefix.
---
---Examples:
---
---```lua
...
---vim.ui._img.set_config(placement_id, { row = 8, col = 12 })
---
----- Remove the placement
---vim.ui._img.del_placement(placement_id)
---
----- Remove the entire image (and all its placements)
---vim.ui._img.del(image_id)
---```
